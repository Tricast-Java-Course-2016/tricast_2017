...
public class LotteryDraw implements Serializable {
    ...
    @Column(name = "lotterygameid")
    private Integer lotteryGameId;
    ...
    public Integer getLotteryGameId() {
        return lotteryGameId;
    }

    public void setLotteryGameId(Integer lotteryGameId) {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((lotteryGameId == null) ? 0 : lotteryGameId.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (lotteryGameId == null) {
            if (other.lotteryGameId != null) {
                return false;
            }
        } else if (!lotteryGameId.equals(other.lotteryGameId)) {
            return false;
        }
    ...
    public String toString() {
        return "LotteryDraw [id=" + id + ", baseStake=" + baseStake + ", gridSize=" + gridSize + ", numbersDrawn="
                ...
                + ", status=" + status + ", winningNumbers=" + winningNumbers + ", lotteryGameId=" + lotteryGameId
