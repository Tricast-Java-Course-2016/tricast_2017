...
public class BetBasicResponse {

    // private List<LotteryGameBasicInfo> lotteryGames;
    private long lotteryGameId; // from lottery games
    private long lotteryDrawId; // from lottery draws
    ...
    public long getLotteryGameId() {
        return lotteryGameId;
    }

    public void setLotteryGameId(long lotteryGameId) {
    ...
    public int hashCode() {
        ...
        result = prime * result + (int) (lotteryDrawId ^ (lotteryDrawId >>> 32));
        result = prime * result + (int) (lotteryGameId ^ (lotteryGameId >>> 32));
    ...
    public boolean equals(Object obj) {
        ...
        BetBasicResponse other = (BetBasicResponse) obj;
